...
import { ChevronLeft, PackageOpen, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen p-4 pb-20 space-y-6 animate-in fade-in slide-in-from-right-4">
      <header className="flex items-center py-4">
        ...
        <h1 className="text-2xl font-bold">Available Lots</h1>
      </header>
      ...
      {lots === undefined ? (
        ...
        <div className="flex flex-col items-center justify-center p-12 text-center text-muted-foreground bg-slate-50 rounded-xl border border-dashed">
          ...
          <p>No lots available at the moment.</p>
        </div>
      ) : (
        <div className="flex flex-col gap-4">
          {lots.map((lot) => (
            ...
            >
              <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-primary shadow-sm">
