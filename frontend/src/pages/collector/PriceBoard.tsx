...
const MOCK_PRICES = [
  ...
  { id: 'BATTERY', label: 'Battery', min: 90, max: 110, trend: 'stable', pct: 0 },
            ...
            <CardContent className="p-4 flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {p.trend === 'stable' && <Badge variant="outline" className="text-slate-600 bg-slate-50"><Minus className="w-3 h-3 mr-1"/> Stable</Badge>}
                </div>
              </div>
