export const CLASS_COLORS: Record<string, { stroke: string; fill: string; rgb: [number, number, number] }> = {
  ...
  MOTOR: { stroke: "#8b5cf6", fill: "rgba(139, 92, 246, 0.35)", rgb: [139, 92, 246] },
  PCB: { stroke: "#10b981", fill: "rgba(16, 185, 129, 0.35)", rgb: [16, 185, 129] },
  PLASTIC: { stroke: "#ec4899", fill: "rgba(236, 72, 153, 0.35)", rgb: [236, 72, 153] },
};
